...
class KGraphNexusGraphImport(tlp.Algorithm):
    def __init__(self, context):
        ...
        print(f"KGraphNexusGraphImport ENDPOINT: {self.KGRAPH_NEXUS_ENDPOINT}", file=sys.stdout)
        print(f"KGraphNexusGraphImport PORT: {self.KGRAPH_NEXUS_PORT}", file=sys.stdout)
...
tulipplugins.registerPluginOfGroup("KGraphNexusGraphImport", "5. KGraphNexusGraphImport", "Marc Hadfield", "13/07/2024", "KGraphNexusGraphImport Info", "0.1.0", "KGraph Query")
