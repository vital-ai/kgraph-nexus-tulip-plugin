...
class KGraphNexusGraphSync(tlp.Algorithm):
    def __init__(self, context):
        ...
        print(f"KGraphNexusGraphSync ENDPOINT: {self.KGRAPH_NEXUS_ENDPOINT}", file=sys.stdout)
        print(f"KGraphNexusGraphSync PORT: {self.KGRAPH_NEXUS_PORT}", file=sys.stdout)
...
tulipplugins.registerPluginOfGroup("KGraphNexusGraphSync", "4. KGraphNexusGraphSync", "Marc Hadfield", "13/07/2024", "KGraphNexusGraphSync Info", "0.1.0", "KGraph Query")
